...
public:
	...
	COXDockTabCtrl		m_wndDockTabCtrl;


// Member functions ---------------------------------------------------------
public:
	void TabAllDockedControlBars(int selectedIndex);
	// In : the index of the control bar to show
	// --- Out : 
	// --- Returns : 
	// --- Effect :				Call this function to cause all docked control bars of this
	//							dockbar to become tabbed. The control bar pointed by pSelected
	//							will become the only visible control bar.

	void TabAllDockedControlBars(COXSizeControlBar* pSelected);
	// --- In  :	pSelected - A pointer to the control bar which will be selected. Cannot be NULL
	// --- Out : 
	// --- Returns : 
	// --- Effect :				Call this function to cause all docked control bars of this
	//							dockbar to become tabbed. The control bar pointed by pSelected
...
// Miscellaneous
	...
	// --- In  :
	// --- Out : 
	// --- Returns : The first real controlbar (not a place holder) of the specified type
	// --- Effect :
	...
	static COXSizeDockBar* GetAppropriateDockBar(CPoint point, CControlBar* pControlBar);
...
protected:
	...
	BOOL RemoveControlBar(CControlBar* pBar, int nPosExclude, int nAddPlaceHolder);
	...
	COXSizeControlBar* GetFirstDockedSizeControlBar(CControlBar* pExclude);
	COXCoolToolBar* GetFirstDockedCoolToolBar(CControlBar* pExclude);
	int GetSizeControlBarCount(CControlBar* pExcludeFromCount);
